...
//  小图的大小
#define ImageWidth ((screenWidth - 22 - 6) / 3)
//  全图的大小
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //_number 总共是多少行
    return CGSizeMake((_imageViewFrame.size.width - ImageWidthClearance * (_number + 1)) / _number, (_imageViewFrame.size.width - ImageWidthClearance * (_number + 1)) / _number);
}
