...
@interface SearchTechniqueVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SearchTechniqueVC
...
- (void)getTechniqueData{
    ...
    __weak SearchTechniqueVC *weakSelf = self;
    
    
    NSString *str = [NSString stringWithFormat:TOM_HOST_SEARCH_TEC_QUE,@"api",@"Tom",@"search_post",oauth_token,oauth_token_secret,1,self.text];
